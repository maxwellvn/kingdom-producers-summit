...
<section class="reg">
  <div class="container pay">
    <div class="pay__card">
      ...
      <p class="pay__lede">We've logged your <?= e(espees_price()) ?> <strong><?= e($methodLabel) ?></strong> payment for reference <strong class="mono"><?= e($registration['reference']) ?></strong>. Our team is confirming it now.</p>
