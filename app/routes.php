...
use App\Controllers\CommitController;
...
$router->get('/pass', [RegistrationController::class, 'passForm']);
$router->post('/pass', [RegistrationController::class, 'passLookup'], [VerifyCsrf::class]);
